...
type PlanetSituation = 'habited' | 'habitable' | 'unhabitable' | 'unexplored'
type Planet = {
    name: string,
...
function addPlanet(name: string, coordinates: PlanetCoords, situation: PlanetSituation) {
    planets.push({
        name,
        coordinates,
        situation,
...
function updateeSituation(planet: Planet, situation: PlanetSituation) {
