...
console.log("M\xE9dia Aritm\xE9tica Simples: ".concat(average(3, 6, 9, 10)));
var weightedAverage = function weightedAverage() {
  ...
  var sum = entries.reduce(function (accum, _ref) {
    ...
    var number = _ref.number,
      weight = _ref.weight;
    return accum + ((_ref2 = number * weight) !== null && _ref2 !== void 0 ? _ref2 : 1);
  }, 0);
  var weightSum = entries.reduce(function (accum, entry) {
    var _ref3;
    return (_ref3 = accum + entry.weight) !== null && _ref3 !== void 0 ? _ref3 : 1;
  }, 0);
...
console.log("Mediana: ".concat(median(5, 7, 2, 3, 8, 10, 11, 15, 9, 2, 3, 4, 5, 7, 9, 10, 12, 14, 18)));
...
console.log("Moda: ".concat(mode(1, 1, 99, 99, 99, 99, 99, 99, 99, 5, 5, 7, 8, 3, 4, 0, 4, 2)));